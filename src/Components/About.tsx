...
function AboutMe() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 text-gray-900 py-16">
      <div className="container mx-auto px-4 md:px-8">
        {/* Section Title */}
        <h2 className="text-5xl font-extrabold text-center text-gray-800 mb-16 animate-fade-in">
          About Me
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 animate-slide-up">
          {/* Education */}
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <FaUserGraduate className="text-6xl text-blue-500 mb-4 mx-auto" />
          ...
          {/* AI & Machine Learning */}
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <FaBrain className="text-6xl text-yellow-500 mb-4 mx-auto" />
          ...
          {/* Medical Imaging */}
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <FaLaptopMedical className="text-6xl text-green-500 mb-4 mx-auto" />
            <h3 className="text-2xl font-semibold mb-2">Medical Imaging</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <MdEngineering className="text-6xl text-red-500 mb-4 mx-auto" />
            <h3 className="text-2xl font-semibold mb-2">Engineering Solutions</h3>
            <p className="text-gray-600">
          ...
          {/* Research & Innovation */}
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <MdScience className="text-6xl text-purple-500 mb-4 mx-auto" />
            <h3 className="text-2xl font-semibold mb-2">Research & Innovation</h3>
            <p className="text-gray-600">
          ...
          {/* Vision */}
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 text-center">
            <FaCogs className="text-6xl text-gray-500 mb-4 mx-auto" />
